...
def upgrade():
    ...
    op.create_table('competition',
                    ...
                    sa.Column('fecha_verificar_licencia',
                              sa.Date(), nullable=True),
                    sa.Column('organizador', sa.String(
                        length=30), nullable=True),
                    sa.Column('limite_participacion',
                              sa.Integer(), nullable=True),
                    sa.Column('email_incidencias', sa.String(
                        length=30), nullable=True),
                    sa.Column('championship_id', sa.Integer(), nullable=False),
                    sa.ForeignKeyConstraint(['championship_id'], [
                                            'championship.id'], ),
                    sa.PrimaryKeyConstraint('id')
                    )
    ...
    op.create_table('user',
                    ...
                    sa.Column('sexo', sa.Enum('Hombre', 'Mujer',
                    ...
                    sa.Column('federado', sa.Enum(
                        'Sí', 'No', name='federado'), nullable=True),
                    sa.Column('role', sa.Enum('User', 'Manager', 'Admin',
                                              name='role'), server_default='User', nullable=False),
                    sa.Column('rider', sa.Enum('Yes', 'No', name='rider'),
                              server_default='No', nullable=True),
